...
export const ErrorCode = {
  ...
  // Queendomino errors
  CANNOT_PLACE_KNIGHT: "CANNOT_PLACE_KNIGHT",
  MAX_KNIGHTS_REACHED: "MAX_KNIGHTS_REACHED",
  KNIGHT_TERRITORY_OCCUPIED: "KNIGHT_TERRITORY_OCCUPIED",
  CANNOT_AFFORD_BUILDING: "CANNOT_AFFORD_BUILDING",
  NO_CONSTRUCTION_SQUARE: "NO_CONSTRUCTION_SQUARE",
  DRAGON_UNAVAILABLE: "DRAGON_UNAVAILABLE",
  QUEEN_HOLDER_CANNOT_USE_DRAGON: "QUEEN_HOLDER_CANNOT_USE_DRAGON",
  BUILDING_NOT_FOUND: "BUILDING_NOT_FOUND",
  INVALID_OPTIONAL_ACTION: "INVALID_OPTIONAL_ACTION",

  // Age of Giants errors
  GIANT_POOL_EMPTY: "GIANT_POOL_EMPTY",
  GIANT_NOT_FOUND: "GIANT_NOT_FOUND",
  INVALID_GIANT_PLACEMENT: "INVALID_GIANT_PLACEMENT",
  NOT_AOG_MODE: "NOT_AOG_MODE",

  // Origins errors
  FIRE_TOKEN_POOL_EMPTY: "FIRE_TOKEN_POOL_EMPTY",
  FIRE_TOKEN_INVALID_POSITION: "FIRE_TOKEN_INVALID_POSITION",
  NO_PENDING_FIRE_TOKEN: "NO_PENDING_FIRE_TOKEN",
  CANNOT_RECRUIT_CAVEMAN: "CANNOT_RECRUIT_CAVEMAN",
  INSUFFICIENT_RESOURCES: "INSUFFICIENT_RESOURCES",
  INVALID_CAVEMAN_PLACEMENT: "INVALID_CAVEMAN_PLACEMENT",
  CAVEMAN_NOT_FOUND: "CAVEMAN_NOT_FOUND",
  NOT_TRIBE_MODE: "NOT_TRIBE_MODE",
} as const;
