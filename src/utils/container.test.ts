...
describe('createContainer', () => {
    it('should register a dependency and return it', () => {
        // Arrange
    ...
    it('should register a singleton dependency and return it', () => {
        // Arrange
        const container = createContainer()
    ...
    it('should replace depency if already exist', () => {
        // Arrange
        const container = createContainer()
        container.register<Logger>('logger', logger, false)
    ...
    it('should not replace a singleton instance', () => {
        // Arrange
        const container = createContainer()
        container.register<Logger>('logger', logger, true)
    ...
    it('should not replace a singleton instance with a normal instance', () => {
        // Arrange
        const container = createContainer()
        container.register<Logger>('logger', logger, true)
    ...
    it('should replace a normal instance with a singleton instance', () => {
        // Arrange
        const container = createContainer()
        container.register<Logger>('logger', logger, false)
    ...
    it('should throw an error when dependency is not found', () => {
        // Arrange
        const container = createContainer()
    ...
    it('should remove a specific dependency', () => {
        // Arrange
        const container = createContainer()
        container.register<Logger>('logger', logger, false)
        container.register<Logger>('secondLogger', secondLogger, true)
